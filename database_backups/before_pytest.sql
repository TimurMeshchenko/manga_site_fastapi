...
-- Started on 2023-12-25 15:46:12
...
1	$2b$12$GCN8YApeX2enJlhu1TFRKuoxm3jbXwjQ0HjRzLSJIqWb0y4cljFUq	\N	f	test	\N	\N	otjnoecpulakz@logodesignex.com	f	t	\N	1.jpg
\.
...
SELECT pg_catalog.setval('public.remanga_comment_id_seq', 82, true);
...
SELECT pg_catalog.setval('public.remanga_comment_rating_id_seq', 146, true);
...
SELECT pg_catalog.setval('public.remanga_title_rating_id_seq', 71, true);
...
SELECT pg_catalog.setval('public.user_bookmarks_id_seq', 185, true);
...
-- Completed on 2023-12-25 15:46:12
